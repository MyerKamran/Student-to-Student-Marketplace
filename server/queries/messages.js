...
export function qMyMessages() {
  return `
    select m.message_id, m.sender_id, m.receiver_id, m.product_id, m.content, m.is_read, m.sent_at,
           us.full_name as sender_name, ur.full_name as receiver_name, p.title as product_title
    from messages m
